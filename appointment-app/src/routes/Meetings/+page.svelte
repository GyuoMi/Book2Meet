...
<div class="hero min-h-screen bg-base-100">
	...
	<div class="lg:text-top">
		<h1 class="text-5xl font-bold" style="position:absolute; top:95px; left:150px">Past Meetings</h1>
		<p class="py-6 text-gray-400 font-medium" style="position:absolute; top:135px; left:150px">
			See Past meetings, Rate meeting, and see your summary notes or comments!
		</p>
	</div>
