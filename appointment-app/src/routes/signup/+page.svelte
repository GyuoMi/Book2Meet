...
-->
	...
	<div
		...
		style="position:absolute; left:600px; height:700px; width:2px"
	>
		<!--
	...
	<div class="lg:text-top">
		<img
			alt="project logo"
			class="absolute top-44 right-24"
			style="position:absolute;width: 45%; height: auto;top:180px;right:120px"
			src="/images/signup1.jpg"
		/>
		<img
			alt="project logo"
			class="absolute top-20 right-64"
			style="position:absolute; width: 20%; height: auto;top:100px; right:150px"
			src="/images/book2meet1.png"
		/>
	</div>
</div>
